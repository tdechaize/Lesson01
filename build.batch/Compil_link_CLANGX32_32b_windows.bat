...
set "CFLAGS=-m32 -fms-extensions -target i686-pc-windows-msvc"
...
clang -m32 -fms-extensions -target i686-pc-windows-msvc -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" -L %LIB3% -L %LIB4% -L %LIB5% objCLANGX32\Debug\%NAME_APPLI%.obj objCLANGX32\Debug\%NAME_APPLI%.res -o binCLANGX32\Debug\%NAME_APPLI%.exe -Wl,--subsystem,console -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
...
clang %CFLAGS% -DDEBUG -D_DEBUG -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%" -o objCLANGX32\Debug\%NAME_APPLI%.obj -c src\%NAME_APPLI%.c
rc /nologo /i"%INC1%" /i"%INC2%" /i"%INC3%" /i"%INC4%" /i"%INC5%" /fo objCLANGX32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m32 -fms-extensions -target i686-pc-windows-msvc -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" objCLANGX32\Debug\%NAME_APPLI%.obj objCLANGX32\Debug\%NAME_APPLI%.res -o binCLANGX32\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
...
clang %CFLAGS% -DDEBUG -D_DEBUG -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%" -o objCLANGX32\Debug\%NAME_APPLI%.obj -c src\%NAME_APPLI%.c
rc /nologo /i"%INC1%" /i"%INC2%" /i"%INC3%" /i"%INC4%" /i"%INC5%" /fo objCLANGX32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m32 -fms-extensions -target i686-pc-windows-msvc -shared -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" -Wl,--out-implib,binCLANGX32\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows objCLANGX32\Debug\%NAME_APPLI%.obj objCLANGX32\Debug\%NAME_APPLI%.res -o binCLANGX32\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
